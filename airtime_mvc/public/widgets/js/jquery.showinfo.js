 ...
 $.fn.airtimeLiveInfo = function(options) {
    ...
    return this.each(function() {
        ...
        function updateWidget(){
            ...
            var currentShowName = "";
            var currentShowDescription = "";
            var currentShowUrl = "";
            var timeElapsed = "";
            var timeRemaining = "";

            var nextShowName = "";
            var nextShowDescription = "";
            var nextShowUrl = "";
            var nextShowRange = "";
            ...
            if (currentShow.length > 0){
                ...
                currentShowName = currentShow[0].getName();
					 currentShowDescription = currentShow[0].getDescription();
            ...
            if (nextShows.length > 0){
                nextShowName = nextShows[0].getName();
					 nextShowDescription = nextShows[0].getDescription();
            ...
            obj.append("<ul class='widget now-playing-bar'>" +
                ...
                "<span id='time-remaining' class='time-remaining'>"+timeRemaining+"</span>"+ ( showDescription ? '<p>' + currentShowDescription + '</p>' : '') +
                "</li>" +
...
(function($){
 $.fn.airtimeWeekScheduleFM = function(options) {
                ...
                for (var j=0; j<daySchedule.length; j++){
                    ...
                    html +=
                      '<tr>'+
                        '<td>'+getTime(daySchedule[j].start_timestamp)+ " - " + getTime(daySchedule[j].end_timestamp)+'</td>'+
                        '<td>'+
                          '<h4>' + (url.length > 0 ? '<a href="'+url+'">' : '' ) +daySchedule[j].name+ (url.length > 0 ? '</a>' : '' ) + '</h4>'+
                        '</td>'+
                        '<td>'+
                          '<ul>'+
                            '<li>'+ daySchedule[j].description+'</li>'+
                          '</ul>'+
                        '</td>'+
                      '</tr>';
                }
...
Show.prototype.getGenre = function () {
	 return this.showData.genre
}
