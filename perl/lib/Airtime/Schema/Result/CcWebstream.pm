use utf8;
package Airtime::Schema::Result::CcWebstream;
...
=head1 TABLE: C<cc_webstream>

=cut

__PACKAGE__->table("cc_webstream");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:wxLa3YA5iLPYTWGqrK+x8A
